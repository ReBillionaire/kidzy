...
import { Star, Users, Trophy, ArrowRight, Sparkles, Shield, ChevronRight, Mail, ArrowLeft } from 'lucide-react';
...
export default function WelcomeScreen() {
  ...
  // Google auth — opens an in-app name entry flow (simulated)
  ...
  if (step === 0) {
    return (
      <div className="min-h-dvh bg-gradient-to-br from-kidzy-purple via-purple-600 to-kidzy-blue flex flex-col items-center justify-center p-6 text-white">
        ...
        {/* Google Auth Modal — proper in-app modal instead of prompt() */}
        {showGoogleFlow && (
          <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-6">
            <div className="bg-white rounded-3xl shadow-2xl p-6 w-full max-w-md animate-slide-up">
              <div className="text-center mb-5">
                <div className="w-16 h-16 bg-white rounded-2xl border-2 border-gray-200 flex items-center justify-center mx-auto mb-3 shadow-sm">
                ...
                <h2 className="text-2xl font-display font-bold text-kidzy-dark">Sign in with Google</h2>
                <p className="text-kidzy-gray text-sm mt-1">Enter your name to continue</p>
                <div className="mt-2 inline-flex items-center gap-1.5 bg-amber-50 text-amber-700 text-xs font-medium px-3 py-1 rounded-full">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-kidzy-purple to-kidzy-blue text-white font-bold py-3.5 rounded-xl shadow-lg disabled:opacity-50 flex items-center justify-center gap-2 hover:shadow-xl transition-all"
              >
                <Sparkles size={18} /> Continue
              </button>
              <button
                onClick={() => { setShowGoogleFlow(false); setGoogleName(''); }}
      ...
      <div className="min-h-dvh bg-gradient-to-br from-kidzy-purple via-purple-600 to-kidzy-blue flex flex-col items-center justify-center p-6">
        <div className="bg-white rounded-3xl shadow-2xl p-6 w-full max-w-md animate-slide-up">
          ...
          {!otpSent ? (
            ...
            <>
              {/* Show the OTP code in a styled demo banner instead of alert() */}
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-xl text-center">
                <p className="text-xs text-blue-600 font-medium mb-1">Demo: Your verification code is</p>
                <p className="text-2xl font-bold text-blue-800 tracking-[0.3em] font-display">{generatedOtp}</p>
              </div>
